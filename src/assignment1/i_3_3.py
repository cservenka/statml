...
from i_3_2 import determineBestK
...
def run():
    ...
    # Repeating exercise I.3.2 with the normalized data sets.
    kBest = determineBestK(normalizedTrain)
    print "k_best = %d" % kBest
    
    print "Training set: Accuracy = %s" % getAccuracy(kBest, normalizedTrain, normalizedTrain)
    print "Test set: Accuracy = %s" % getAccuracy(kBest, normalizedTrain, normalizedTest)
